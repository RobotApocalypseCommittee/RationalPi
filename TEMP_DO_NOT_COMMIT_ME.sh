...
cmake -D CMAKE_BUILD_TYPE=RELEASE -D CMAKE_INSTALL_PREFIX=$(python3 -c "import sys; print(sys.prefix)") -D PYTHON_EXECUTABLE=$(which python3) -D OPENCV_EXTRA_MODULES_PATH=~/opencv_contrib/modules ..
...
rm -r opencv_contrib
echo Completed !
echo You now can use OpenCV 3.3.0 in both Python 2 and Python 3 !